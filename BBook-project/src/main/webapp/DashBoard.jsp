...
<body>
        ...
        <nav class="navbar2">
            ...
            <div class="hm">
                ...
                <%
					...
					%>
                <% if (username != null) { %>
                <a href="Profile.jsp"><i class="fa-solid fa-user"></i>
                <span style="font-size:15px; font-weight:bold; color:aqua;">Welcome, <%= username %>!</span>
                </a>
		...
		<div class="cart-img">
			    <%
			        try {
			            ...
			            String sql = "SELECT * FROM addbook ORDER BY id DESC LIMIT 20"; // You can limit to recent books
			    ...
			    %>
			        <div class="cart-img1">
			            <a href="BuyBook.jsp?id=<%= id %>">
			                <img src="DisplayImageServlet?id=<%= id %>" alt="Book Image" />
			            </a>
			    ...
			    <%
			            ...
			            out.println("<p style='color:red;'>Failed to load books: " + e.getMessage() + "</p>");
			        }
			    %>
			</div>
            ...
            <!-- <div class="cart-img1">
                <a href="BuyBook.jsp?id=1"><img src="image2/b1.jpg" alt=""></a>
                <p class="book-title">The martin:</p>
                <span>Price: 240/only</span>
            </div> -->
            <!-- <div class="cart-img1">
                <a href="BuyBook.jsp?id=2"><img src="image2/b2.jpg" alt=""></a>
                <p class="book-title">The Brain Work:</p>
                <span>Price: 240/only</span>
            </div>
            <div class="cart-img1">
                <a href="BuyBook.jsp?id=3"><img src="image2/b3.jpg" alt=""></a>
                <p class="book-title">Your Mind:</p>
                <span>Price: 240/only</span>
            </div> -->
            <!-- <div class="cart-img1">
                <a href="BuyBook.jsp?id=4"><img src="image2/b4.jpg" alt=""></a>
                <p class="book-title">Personal Growth:</p>
                <span>Price: 240/only</span>
            </div>
            <div class="cart-img1">
                <a href="BuyBook.jsp?id=5"><img src="image2/b5.jpg" alt=""></a>
                <p class="book-title">The Gold Bat:</p>
                <span>Price: 240/only</span>
            </div>
            <div class="cart-img1">
                <a href="BuyBook.jsp?id=6"><img src="image2/b4.jpg" alt=""></a>
                <p class="book-title">Peersonal Growth:</p>
                <span>Price: 240/only</span>

            </div>
            <div class="cart-img1">
                <a href="BuyBook.jsp?id=7"><img src="image2/b5.jpg" alt=""></a>
                <p class="book-title">The Goat Bat:</p>
                <span>Price: 240/only</span>
            </div> -->
    </div>
    <div class="card2">
    ...
    <div class="card5">
        ...
        <img style="width: 30%; height="30%";" src="image2/textbook (2).png" alt="">
        <img style="width: 18%; height="30%";" src="image2/childbook.png" alt="">
        <img style="width: 18%; height="30%";" src="image2/activitybook.png" alt="">
        <img style="width: 30%; height="30%";" src="image2/stationary.png" alt="">
        <!-- <div class="childbook"></div>
        <div class="acbook"></div>
        <div class="sta"></div> -->
    </div>
    <hr>
    <div class="footer">
    ...
    <script>
        ...
        searchInput.addEventListener('input', function () {
          ...
          const bookCards = document.querySelectorAll('.cart-img1', '.card2-img', '.card3-img', '.card4-img');
